...
Public Class RptStockInHand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptStockInHand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockInHand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockInHand = New RptStockInHand()
        rpt.Site = Me.Site
        Return rpt
    End Function
