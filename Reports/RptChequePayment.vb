...
Public Class RptChequePayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptChequePayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptChequePayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptChequePayment = New RptChequePayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
