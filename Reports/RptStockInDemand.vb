...
Public Class RptStockInDemand
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptStockInDemand.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockInDemand
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockInDemand = New RptStockInDemand()
        rpt.Site = Me.Site
        Return rpt
    End Function
