...
Public Class RptVendorWisePurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptVendorWisePurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVendorWisePurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVendorWisePurchase = New RptVendorWisePurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
