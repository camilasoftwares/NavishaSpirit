...
Public Class RptDestructionSlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptDestructionSlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDestructionSlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDestructionSlip = New RptDestructionSlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
