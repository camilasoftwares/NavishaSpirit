...
Public Class RptPatientWiseSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptPatientWiseSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPatientWiseSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPatientWiseSale = New RptPatientWiseSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
