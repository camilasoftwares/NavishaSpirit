...
Public Class RptItemwisePartywiseSale
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptItemwisePartywiseSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptItemwisePartywiseSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptItemwisePartywiseSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptItemwisePartywiseSale = New RptItemwisePartywiseSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
