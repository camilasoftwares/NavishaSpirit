...
Public Class RptSaleRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptSaleRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSaleRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSaleRegister = New RptSaleRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
