...
Public Class RptItemsAvailability
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptItemsAvailability.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptItemsAvailability.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ReportBy() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptItemsAvailability
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptItemsAvailability = New RptItemsAvailability()
        rpt.Site = Me.Site
        Return rpt
    End Function
