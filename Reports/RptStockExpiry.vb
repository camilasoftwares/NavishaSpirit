...
Public Class RptStockExpiry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptStockExpiry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockExpiry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockExpiry = New RptStockExpiry()
        rpt.Site = Me.Site
        Return rpt
    End Function
