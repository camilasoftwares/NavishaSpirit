...
Public Class RptStockAndSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptStockAndSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptStockAndSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptStockAndSale = New RptStockAndSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
