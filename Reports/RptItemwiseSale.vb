...
Public Class RptItemwiseSale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.RptItemwiseSale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptItemwiseSale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptItemwiseSale = New RptItemwiseSale()
        rpt.Site = Me.Site
        Return rpt
    End Function
