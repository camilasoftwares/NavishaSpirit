...
Public Class DlgPurchaseRpt
    ...
    Private Sub DlgPurchaseRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub EnterKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles OptSpecific.KeyDown, OptBetween.KeyDown, OptAllRecords.KeyDown, DtPkrDateTo.KeyDown, DtPkrDateFrom.KeyDown
    ...
    Private Sub BtnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShow.Click
        Try
            ...
            Dim ds As DataSet = GetPurchase(Me.Name, dateFrom, dateTo)
            ...
            'Opening Report
            SetWaitCursor()
            Dim rpt As New RptDatewisePurchase
