Public Class DlgStockRpt
    ...
    Private Sub DlgStockReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FillComboBoxValues()
    ...
    Private Sub BtnShowReport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShowReport.Click
        Try
            ...
            Dim ds As DataSet = GetStock(Me.Name, False, categoryId, itemId, manufacturerId, storageId, scheduleId)
