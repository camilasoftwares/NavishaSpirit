Public Class DlgGrossSalesRpt
    ...
    Private Sub DlgGrossSalesRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        OptAll.Checked = True
        DtPkrDateFrom.Visible = False
        DtPkrDateTo.Visible = False
        LoadComboBoxValuesForLoginName()
    End Sub

    Private Sub LoadComboBoxValuesForLoginName()
        Try
            ...
            For Each user In users
                AddItemToComboBox(user.Name, user.Id, CmbLoginName)
            Next
    ...
    Private Sub BtnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShow.Click
        Try
            ...
            Dim userId As String = CmbLoginName.Text.Trim
            Dim ds As DataSet = GetGrossSales(Me.Name, dateFrom, dateTo, userId)
    ...
    Private Sub EnterKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles OptSpecific.KeyDown, OptBetween.KeyDown, OptAll.KeyDown, DtPkrDateTo.KeyDown, DtPkrDateFrom.KeyDown, CmbLoginName.KeyDown
