...
Public Class DlgPurchaseReturnRpt
    ...
    Private Sub DlgPurchaseReturnRpt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        OptAll.Checked = True
    End Sub
    ...
    Private Sub BtnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnShow.Click
        Try
            ...
            Dim ds As DataSet = GetPurchaseReturn(Me.Name, dateFrom, dateTo)
            ...
            'Opening Report
            SetWaitCursor()
            Dim rpt As New RptDatewisePurchaseReturn
