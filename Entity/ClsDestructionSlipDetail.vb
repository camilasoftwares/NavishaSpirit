Public Class ClsDestructionSlipDetail

    Private sId As Long = cInvalidId
    Private sDestructionSlipId As Integer = cInvalidId
    ...
    Private sDestructionQuantity As Double = 0
    ...
    Public Property DestructionSlipId() As Integer
        Get
            Return sDestructionSlipId
        End Get
        Set(ByVal value As Integer)
            sDestructionSlipId = value
        End Set
    End Property
    ...
    Public Property DestructionQuantity() As Double
        Get
            Return sDestructionQuantity
        End Get
        Set(ByVal value As Double)
            sDestructionQuantity = value
        End Set
    End Property
    ...
    Public Function GetTotal() As Double
        ...
        Try
            result = (sDestructionQuantity * sPricePurchase) + sTaxAmount - sDiscountAmount
