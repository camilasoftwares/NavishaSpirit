Public Class ClsPurchaseReturnDetail

    Private sId As Long = cInvalidId
    Private sPurchaseReturnId As Integer = cInvalidId
    Private sPurchaseId As Long = cInvalidId
    ...
    Public Property PurchaseReturnId() As Integer
        Get
            Return sPurchaseReturnId
        End Get
        Set(ByVal value As Integer)
            sPurchaseReturnId = value
        End Set
    End Property
    ...
    Public Function GetTotal() As Double
        ...
        Try
            Dim total As Double = sReturnQuantity * sPricePurchase
