Public Class ClsSalesDetail
    ...
    Private sSaleQuantity As Double = 0
    ...
    Public Property SaleQuantity() As Double
        Get
            Return sSaleQuantity
        End Get
        Set(ByVal value As Double)
            sSaleQuantity = value
        End Set
    ...
    Public Function GetTotal() As Double
        ...
        Try
            'result = (sSaleQuantity * sPriceSale) + sTaxAmount - sDiscountAmount
            result = (sSaleQuantity * sPriceSale) - sDiscountAmount
        ...
        Return result
    End Function
    Public Function GetTotal1() As Double
        Dim result As Double = 0
        Try
            result = (sSaleQuantity * sPriceSale) + sTaxAmount - sDiscountAmount
            'result = (sSaleQuantity * sPriceSale) - sDiscountAmount
