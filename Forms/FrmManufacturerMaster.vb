...
Public Class FrmManufacturerMaster
...
#Region "Control Functions"
    ...
    Private Sub FrmManufacturerMaster_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetControls()
    End Sub
    ...
    Private Sub GrdManufacturerDetails_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles GrdManufacturerDetails.CellDoubleClick
        Try
            If e.RowIndex < 0 Then Exit Try
            If AndedTheString(gUser.AuthorizationNo, Authorization.Manufacturers_NoUpdate) = True Then Exit Sub

            editRow = GrdManufacturerDetails.Rows(e.RowIndex)
            With editRow
    ...
    Private Sub GrdManufacturerDetails_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles GrdManufacturerDetails.KeyDown
        If e.KeyCode = Keys.Tab Then Me.SelectNextControl(Me.ActiveControl, True, True, True, True)
    End Sub

    Private Sub BtnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        Try
            If AndedTheString(gUser.AuthorizationNo, Authorization.Manufacturers_NoAdd) = True Then Exit Sub
            If ValidateValues() = False Then Exit Sub

            Dim manufacturer As New ClsManufacturerMaster
            With manufacturer
                .Name = TxtName.Text
            ...
            Dim id As Integer = InsertIntoManufacturerMaster(Me.Name, manufacturer)
            If id > 0 Then
                flagChange = True
                manufacturer.Id = id
                InsertIntoGrid(manufacturer)
            End If
    ...
    Private Sub BtnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdate.Click
        Try
            ...
            If UpdateManufacturerMaster(Me.Name, manufacturer) <> EnResult.Change Then Exit Sub
...
#Region "Private Functions"
    ...
    Private Sub SetTabIndex()
        GrpManufacturer.TabIndex = Index.GrpManufacturer
        ...
        GrpManufacturerDetails.TabIndex = Index.GrpManufacturerDetails
        GrdManufacturerDetails.TabIndex = Index.GrdManufacturerDetails
    End Sub

    Private Sub SetGrid()
        With GrdManufacturerDetails
    ...
    Private Sub LoadGridValues()
        Try
            GrdManufacturerDetails.Rows.Clear()
    ...
    Private Sub LoadGridValuesWithSearchLike(ByVal txtLike As String)
        Try
            ...
            Dim manufacturers() As ClsManufacturerMaster = GetAllManufacturerMasterLike(Me.Name, field, txtLike)
            If manufacturers Is Nothing Then Exit Try
    ...
    Private Sub InsertIntoGrid(ByRef manufacturerObj As ClsManufacturerMaster)
        Try
            If manufacturerObj Is Nothing Then Exit Try

            Dim rowIndex As Integer = GrdManufacturerDetails.Rows.Add
            With GrdManufacturerDetails.Rows(rowIndex)
                .Cells(cId).Value = manufacturerObj.Id
                .Cells(cName).Value = manufacturerObj.Name
                .Cells(cAddress).Value = manufacturerObj.Address
                .Cells(cCity).Value = manufacturerObj.City
                .Cells(cPin).Value = manufacturerObj.Pin
                .Cells(cMobile).Value = manufacturerObj.Mobile
                .Cells(cPhoneR).Value = manufacturerObj.PhoneR
                .Cells(cPhoneO).Value = manufacturerObj.PhoneO
                .Cells(cEmail).Value = manufacturerObj.EMail
                .Cells(cUserId).Value = manufacturerObj.UserId
                .Cells(cDateOn).Value = manufacturerObj.DateOn
                .Cells(cRepresentative).Value = manufacturerObj.Representative
                .Cells(cPhoneRepresentative).Value = manufacturerObj.PhoneRepresentative
                InsertIntoComboBoxForRepresentative(manufacturerObj.Representative)
            End With
    ...
    Private Function ValidateValues() As Boolean
        ...
        Try
            ...
            If TxtName.Text.Trim = "" Then
                ErrorInData("Please enter Manufacturer name.", TxtName)
                Exit Try
            End If
